 ...
 * @version 28-06-2023
 */
public class Detect_liveTimeFraction_Neuron_ALife extends Input_Neuron_ALife
{
    // Fields ----------------------------------------------------------------------------
     ...
     */
    public Detect_liveTimeFraction_Neuron_ALife(Detect_liveTimeFraction_Neuron_ALife n){
        super(n);
     ...
     */
    public static Detect_liveTimeFraction_Neuron_ALife dupeNeuron_ALife(Detect_liveTimeFraction_Neuron_ALife n){
        //Its not override since input and output parameters classes are diferent
        if (n.creature == null) return null;
        Detect_liveTimeFraction_Neuron_ALife newN = new Detect_liveTimeFraction_Neuron_ALife(n);
        return newN;
