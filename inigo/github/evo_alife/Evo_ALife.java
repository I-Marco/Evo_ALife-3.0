...
public class Evo_ALife extends JFrame{
    ...
    private void makeMenuBar(JFrame frame) {
        ...
        //Tests Proyecto
        JMenuItem testNewWorldProy = new JMenuItem("Create new enviroment Type 100x100- Creatures For project");
     ...
     * Make a environment for simple creature test
     */
    private void makeDefaultEnvCreatureProy(){
        java.util.List<Object> env_Vars = null; // List in java.util and java.awt
        if (env_ALife != null) {
            env_Vars = env_ALife.getEnvVars();
            this.env_ALife.killThread();
        ...
        auxM = Mind_ALife.test1Mind(auxC);
        auxC.setMind(auxM);
