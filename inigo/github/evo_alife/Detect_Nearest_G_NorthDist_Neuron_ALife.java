...
public class Detect_Nearest_G_NorthDist_Neuron_ALife extends Input_Neuron_ALife
{
    ...
    /**
     * public Detect_Nearest_G_NorthDist_Neuron_ALife dupeNeuron_ALife()
     * 
     * This method is used to dupe a neuron
     * @param  None
     * @return Detect_Nearest_G_NorthDist_Neuron_ALife the new neuron
     */
    public Detect_Nearest_G_NorthDist_Neuron_ALife dupeNeuron_ALife(){
        this.lockNeuron.lock();
        try{
            Detect_Nearest_G_NorthDist_Neuron_ALife newN = new Detect_Nearest_G_NorthDist_Neuron_ALife(this);
            return newN;
        }finally{
            this.lockNeuron.unlock();
        }
