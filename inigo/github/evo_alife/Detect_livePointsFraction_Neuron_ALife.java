 ...
 * @version 28-06-2023
 */
public class Detect_livePointsFraction_Neuron_ALife extends Input_Neuron_ALife
{
    // Fields ----------------------------------------------------------------------------
     ...
     */
    public Detect_livePointsFraction_Neuron_ALife(Detect_livePointsFraction_Neuron_ALife n){
        super(n);
